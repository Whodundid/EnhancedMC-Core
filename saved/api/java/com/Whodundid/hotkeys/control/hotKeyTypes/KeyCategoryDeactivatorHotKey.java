...
public class KeyCategoryDeactivatorHotKey extends HotKey {
	...
	public KeyCategoryDeactivatorHotKey(String keyNameIn, KeyComboAction keysIn, String categoryNameIn, boolean builtInVal, String descriptionIn, String builtInSubModTypeIn) {
		super(keyNameIn, keysIn, builtInVal, KeyActionType.CATEGORY_DEACTIVATOR, builtInSubModTypeIn);
