...
public class SLCMainGui extends WindowParent {
	...
	public SLCMainGui() { super(); }
	public SLCMainGui(Object oldGuiIn) { super(oldGuiIn); }
	public SLCMainGui(int posX, int posY) { super(posX, posY); }
	public SLCMainGui(int posX, int posY, Object oldGuiIn) { super(posX, posY, oldGuiIn); }
	...
	public void initObjects() {
		...
		larmBtn = new EGuiButton(this, midX + 47, midY - 35, 46, 20, slc.skinFrontFacing ? "L Arm" : "R Arm");
		rarmBtn = new EGuiButton(this, midX - 93, midY - 35, 46, 20, slc.skinFrontFacing ? "R Arm" : "L Arm");
		llegBtn = new EGuiButton(this, midX + 47, midY + 16, 46, 20, slc.skinFrontFacing ? "R Leg" : "L Leg");
		rlegBtn = new EGuiButton(this, midX - 93, midY + 16, 46, 20, slc.skinFrontFacing ? "L Leg" : "R Leg");
		headBtn = new EGuiButton(this, midX - 23, midY - 121, 46, 20, "Hat");
		jackBtn = new EGuiButton(this, midX - 93, midY - 86, 46, 20, "Jacket");
		capeBtn = new EGuiButton(this, midX + 47, midY - 86, 46, 20, "Cape");
		
		optionsBtn = new EGuiButton(this, midX + 41, midY + 76, 55, 20, "Options");
		flipBtn = new EGuiButton(this, midX - 22, midY + 76, 55, 20, "Flip All");
		stateBtn = new EGuiButton(this, midX - 95, midY + 76, 65, 20, state);
		valueUpBtn = new EGuiButton(this, midX - 95, midY - 123, 58, 20, "All + " + slc.currentChangeValue);
		valueDownBtn = new EGuiButton(this, midX + 37, midY - 123, 58, 20, "All - " + slc.currentChangeValue);
		resetProfileBtn = new EGuiButton(this, midX - 1, midY + 104, 45, 20, "Reset");
		loadProfileBtn = new EGuiButton(this, midX + 51, midY + 104, 45, 20, "Load");
	...
	public void drawObject(int mXIn, int mYIn) {
		mc.renderEngine.bindTexture(skinType.equals("slim") ? SLCResources.SLSsettingsGuiAlex : SLCResources.SLSsettingsGuiSteve);
	...
	public void actionPerformed(IEnhancedActionObject object, Object... args) {
		...
		if (object.equals(resetProfileBtn)) {
			if (slc.currentLoadedProfile == slc.currentSkinProfile) {
				...
				case SW: slc.setGlobalSwitch(true); stateBtn.setDisplayString("All Switch"); break;
				case BL: slc.setGlobalBlink(true); stateBtn.setDisplayString("All Blink"); break;
				case IN: slc.setGlobalSwitch(false); slc.setGlobalBlink(false); stateBtn.setDisplayString("Individual"); break;
				case N: slc.setGlobalSwitch(false); slc.setGlobalBlink(false); stateBtn.setDisplayString("Off"); break;
				}
	...
	private void changeStateBtn() {
		...
		case SW: slc.globalOn = true; slc.setGlobalSwitch(true); stateBtn.setDisplayString("All Switch");  break;
		case BL: slc.setGlobalBlink(true); stateBtn.setDisplayString("All Blink"); break;
		case IN: slc.setGlobalSwitch(false); slc.setGlobalBlink(false); stateBtn.setDisplayString("Individual"); break;
		case OFF: slc.globalOn = false; stateBtn.setDisplayString("Off"); break;
		}
	...
	private void drawMouseEnteredBtn() {
		mc.renderEngine.bindTexture(SLCResources.SLSsettingsGuiSteve);
		//rotate button
		...
		if (mouseY >= midY + 57 && mouseY <= midY + 67) {
			if (mouseX >= midX + 24 && mouseX <= midX + 43) {
				...
				if (slc.skinFrontFacing) {
					llegBtn.setDisplayString("L Leg");
					rlegBtn.setDisplayString("R Leg");
					larmBtn.setDisplayString("L Arm");
					rarmBtn.setDisplayString("R Arm");
				} else {
					llegBtn.setDisplayString("R Leg");
					rlegBtn.setDisplayString("L Leg");
					larmBtn.setDisplayString("R Arm");
					rarmBtn.setDisplayString("L Arm");
				}
				slc.getConfig().saveMainConfig();
				resetProfileBtn.playPressSound();
			}
	...
	private void openPartGUI() { EnhancedMC.displayWindow(new SLCPartGui(), this); }
	private void openOptionsGui() { EnhancedMC.displayWindow(new SLCGlobalOptionsGui(), this); }
}
