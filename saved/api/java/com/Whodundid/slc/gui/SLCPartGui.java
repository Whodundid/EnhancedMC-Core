...
public class SLCPartGui extends WindowParent {
	...
	public SLCPartGui() { super(); }
	public SLCPartGui(Object oldGuiIn) { super(oldGuiIn); }
	public SLCPartGui(int posX, int posY) { super(posX, posY); }
	public SLCPartGui(int posX, int posY, Object oldGuiIn) { super(posX, posY, oldGuiIn); }
	...
	public void initObjects() {
		...
		doneBtn = new EGuiButton(this, midX + 56, midY + 104, 40, 20, "Done");
		resetBtn = new EGuiButton(this, midX + 9, midY + 104, 40, 20, "Reset");
		fiveUpBtn = new EGuiButton(this, midX + 70, midY + 76, 25, 20, "+5");
		twoFiveUpBtn = new EGuiButton(this, midX + 39, midY + 76, 25, 20, "+25");
		hundredUpBtn = new EGuiButton(this, midX + 2, midY + 76, 30, 20, "+100");
		hundredDownBtn = new EGuiButton(this, midX - 36, midY + 76, 30, 20, "-100");
		twoFiveDownBtn = new EGuiButton(this, midX - 67, midY + 76, 25, 20, "-25");
		fiveDownBtn = new EGuiButton(this, midX - 94, midY + 76, 20, 20, "-5");
	...
	public void drawObject(int mXIn, int mYIn) {
		mc.renderEngine.bindTexture(SLCResources.SLSpartGui);
