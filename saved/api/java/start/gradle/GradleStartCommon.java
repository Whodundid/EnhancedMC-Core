...
public abstract class GradleStartCommon {
	...
	public AccPicker gui;

	static final File SRG_DIR = new File("C:/Users/Hunter/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/20/srgs");
	static final File SRG_NOTCH_SRG = new File("C:/Users/Hunter/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/20/srgs/notch-srg.srg");
	static final File SRG_NOTCH_MCP = new File("C:/Users/Hunter/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/20/srgs/notch-mcp.srg");
	static final File SRG_SRG_MCP = new File("C:/Users/Hunter/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/20/srgs/srg-mcp.srg");
	static final File SRG_MCP_SRG = new File("C:/Users/Hunter/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/20/srgs/mcp-srg.srg");
	static final File SRG_MCP_NOTCH = new File("C:/Users/Hunter/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/20/srgs/mcp-notch.srg");
	static final File CSV_DIR = new File("C:/Users/Hunter/.gradle/caches/minecraft/de/oceanlabs/mcp/mcp_stable/20");
	...
	public void setGui(AccPicker guiIn) { gui = guiIn; }
		...
		for (String key : argMap.keySet()) {
			if (list.contains(key)) {
				for (int i = 0; i < list.size(); i++) {
					String s = list.get(i);
					if (s.equals(key)) {
						argMap.put(key, list.get(i + 1));
						if (!"password".equalsIgnoreCase(key)) { LOGGER.info(key + ": " + list.get(i + 1)); }
					}
				}
			}
		}
