...
public class EGuiRightClickMenu extends ActionWindowParent {
	...
	public EGuiRightClickMenu setDontCloseOnPress(boolean val) { dontCloseOnPress = val; return this; }
	...
	@Override public EGuiRightClickMenu setActionReceiver(IEnhancedGuiObject objIn) { actionReciever = objIn; return this; }
