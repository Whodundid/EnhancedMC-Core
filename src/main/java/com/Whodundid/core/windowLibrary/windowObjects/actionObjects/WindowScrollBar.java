...
public class WindowScrollBar extends ActionObject {
	...
	@Override
	public WindowScrollBar setPosition(int newX, int newY) {
	...
	public WindowScrollBar setScrollBarPos(int pos) {
	...
	public WindowScrollBar reset() { setScrollBarPos(0); return this; }
	...
	public WindowScrollBar setHighVal(int valIn) { setScrollBarValues(visibleAmount, valIn, drawVertical() ? height : width); return this; }
	public WindowScrollBar setLowVal(int valIn) { setScrollBarValues(valIn, highVal, drawVertical() ? height : width); return this; }
