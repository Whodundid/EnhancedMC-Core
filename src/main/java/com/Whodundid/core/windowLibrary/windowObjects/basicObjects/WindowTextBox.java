...
public class WindowTextBox extends WindowObject {
	...
	public WindowTextBox(IWindowObject parent, int x, int y) { this(parent, x, y, null); }
	public WindowTextBox(IWindowObject parent, int x, int y, EArrayList<String> linesIn) {
		init(parent);
		xPos = x;
		yPos = y;
